...
public class StringUtil
{
     ...
     * @author zhangyu
     */
    public static Long toLongPlus(String str, Long def) {
        Long result = def;
        try {
            if (isNotEmpty(str)) {
	...
	public static boolean isBooleanType(String str)
	{
		...
		if (null == tmpStr)
		{
			...
			return tmpStr.equalsIgnoreCase("true") || tmpStr.equalsIgnoreCase("false");
	}
	...
	public static String removeLastStr(String str, String lastStr)
	{
		...
		{
			if (str.indexOf(lastStr) != -1 && str.lastIndexOf(lastStr) == str.length() - 1)
			{
